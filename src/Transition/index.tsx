...
const Transition: FunctionComponent<TransitionProps> = props => {
  ...
  useLayoutEffect(() => {
    ...
    if (divEl && divEl.current) {
      const preset = beStyleStr((visible ? beforeEnter : beforeLeave) || {});
      ...
      const after = beStyleStr((visible ? afterEnter : afterLeave) || {}, {
  ...
  return shouldRender ? (
    <div className={sc("w-transition", props.className)} ref={divEl}>
